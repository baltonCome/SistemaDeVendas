...
public class AlterarSenhaFunc extends JFrame {
    ...
    public AlterarSenhaFunc(String idFunc){
            ...
            public void actionPerformed(ActionEvent e){
                try {
                    if(!SalvarFuncionario.mostrar().isEmpty()){
                        ...
                        ArrayList <Funcionario> gestor = SalvarFuncionario.mostrar();
                        if(SalvarFuncionario.isFuncionario(gestor, inserirId.getText(), inserirAtual.getPassword())){
                            
                            if (vege.matches(inserirRedo.getPassword(), inserirNova.getText())){
                                
                                SalvarFuncionario.alterarSenha(gestor, inserirId.getText(), inserirNova.getText());
